...
def optimization_result():
    ...
    return config, timeline, run_optimization(config, timeline)


def test_export_optimization_to_excel_writes_all_expected_sheets(tmp_path, optimization_result):
    config, timeline, result = optimization_result
    ...
    export_optimization_to_excel(str(path), timeline, result, credit_metrics)
